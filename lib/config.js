  ...
  baseURL: Joi.string()
    ...
    .when(Joi.ref('authorizationParams.response_mode'), {
      ...
      then: Joi.string().pattern(isHttps).rule({
        warn: true,
        message: `Using 'form_post' for response_mode may cause issues for you logging in over http, see https://github.com/authok/express-openid-connect/blob/master/FAQ.md`,
      }),
    }),
